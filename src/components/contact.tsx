    ...
    return (
      <div className="w-full mt-16 mb-8 pt-22" id={id}>
                ...
                <div className="terminal-style-contact w-full max-w-3xl p-6 border-2 border-white bg-back bg-opacity-80 text-left">
                      ...
                      <br></br>
                        <span className="text-white font-mono"> $ cd contacts</span>
                      </div>
                      ...
                      <span className="text-blue-400 font-mono"> ~/contacts</span><br></br>
                        ...
                        <div className="font-mono mt-4 pl-4">
                          ...
                          <div className="col-span-1 text-blue-400">
                            ...
                            <a href="mailto:srijankulal1010@gmail.com" className="text-white text-lg hover:underline">
                            contact@srijank.com
                            </a>
                          </div>
                          </div>
                          ...
                          <div className="col-span-1 text-blue-400">
                            ...
                            <a href="https://github.com/srijankulal" className="text-white text-lg hover:underline">
                          ...
                          <div className="col-span-1 text-blue-400">
                            ...
                            <a href="http://www.linkedin.com/in/srijan-kulal" className="text-white text-lg hover:underline">
